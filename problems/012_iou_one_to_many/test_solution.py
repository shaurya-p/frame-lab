import numpy as np
import pytest
from solution import iou_one_to_many
...
def test_partial_overlap():
    ...
    # intersection=25, area_box=100, area_candidate=100, union=175
...
def test_candidate_fully_inside_query():
    ...
    # intersection=36, area_box=100, area_candidate=36, union=100
...
def test_query_fully_inside_candidate():
    ...
    boxes = np.array([[0, 0, 10, 10]], dtype=float)
    # intersection=36, area_box=36, area_candidate=100, union=100
    np.testing.assert_allclose(iou_one_to_many(box, boxes), [36 / 100], rtol=1e-6)
...
def test_float_coordinates():
    ...
    # intersection=0.25, area_box=1.0, area_candidate=1.0, union=1.75
